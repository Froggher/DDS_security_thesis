...
possiamo notare che i messaggi di default sono molto verbose, 
...
il funzionamento si basa su messaggi di tipo multicast che vengono
...
Di solito questo tipo di attacco è difficile da identificare e può essere
...
non sono però sufficienti per mitigare questo attacco:
\begin{itemize}
...
Modificando ripetutamente questi valori, l'attaccante
...
OWNERSHIP\_KIND che gestisce quanti DataWriter possono scrivere per un
...
\begin{itemize}
    \item SHARED: in questo modo più DataWriter possono aggiornare le
...
policy dei DataWriter in modo tale da avere il valore LIFESPAN molto piccolo. 
Così
