...
\begin{itemize}
    ...
    \item Il sottomessaggio INFO\_TS ci informa che questo pacchetto è diretto 
    a più entità all'interno della rete data la mancanza del guidPrefix al 
    suo interno. Se invece fosse stato un sottomessaggio INFO\_DST,
    il guidPrefix sarebbe stato 
    incluso, in quanto il messaggio sarebbe probabilmente diretto a un'unica
