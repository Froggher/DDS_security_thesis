...
All'interno del topic troviamo sempre una chiave (key) che 
sono uno o piú data types del topic stesso.
...
con id\_macchina 
uguale a 2. L'id\_macchina fungerà da key 
...
Un esempio di un permission document é parzialmanente 
mostrato nel Codice~\ref{Access Control Service Plugin} 
che ci indica che ha una validità che parte dal 26 ottobre 2013
...
soluzioni proprietarie come RTI Connext DDS 
dispone di un più ampio supporto per diversi linguaggi di 
